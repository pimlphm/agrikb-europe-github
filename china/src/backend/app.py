...
def create_app() -> "FastAPI":
    ...
    def api_competition_headlines(location: str = "江苏句容", force: bool = False) -> dict:
    ...
    def api_regional_live(
        ...
        query: str = "江苏句容 农业 天气 气温 收购 政策 新闻",
        production_location: str = "江苏句容",
        market_location: str = "镇江农产品批发市场",
    ...
    def _create_word_report(request: WordReportRequest):
        query = request.query.strip() or "请生成当前农业知识库的专业概览报告"
